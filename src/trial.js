...
function Signup() {
	{/*Managing the state of data in the form */ };
				...
				<div className="flex flex-col justify-center ml-20">
					...
					<div
						...
						<div className="mb-1 sm:mb-2">
							<label className="inline-block mb-1 text-x font-medium pb-2">Username</label>
							<input
						...
						{/*Password div */}
						<div className="mb-1 sm:mb-2">
							<label className="inline-block mb-1 text-x font-medium pb-2">Password</label>
							<input
						...
						<div className="mb-1 sm:mb-2">
							<label className="inline-block mb-1 text-x font-medium pb-2">Confirm Password</label>
							<input
